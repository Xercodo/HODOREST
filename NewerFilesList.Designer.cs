namespace HODOREST
{
	partial class NewerFilesList
	{
		...
		private void InitializeComponent()
		{
			...
			this.listView1.Size = new System.Drawing.Size(423, 286);
			...
			this.label1.Text = "The following files are newer than the currnet HOD:";
			// 
			// NewerFilesList
			// 
			...
			this.Name = "NewerFilesList";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Newer Files";
